...
%
% System nie zawsze może sobie pozwolić na bycie kontrolowanym przez jedną, główną jednostkę. Ograniczać to może przede wszystkim stan połączenia. Należy więc udostępnić możliwość komunikowania się robotom bezpośrednio między sobą. Takie rozwiązanie zmusza wszystkich agentów do
